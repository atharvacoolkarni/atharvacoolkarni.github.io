...
description: "An in-depth analysis of Pune's public transportation challenges, examining the causes of overcrowded PMPML buses and proposing data-driven solutions for improving urban mobility."
date: 2024-09-19
categories: 
  - Urban planning
  - Public transport
...
: Table 1: Population of Pune (lakhs), 1981 to 2011 {tbl-colwidths="[50,50]"}
...
![Figure 1: Population of Pune (lakhs), 1981 to 2011](..\assets\blogs\pune-transportation\Pune_population_chart.png){width=1000}
...
![Figure 2: Population density of Pune (with new villages), 1981 - 2024](assets/blogs/pune-transportation/Pune population (with villages).png){width="900" height="500"}
...
![Figure 3: Population density of Pune (without new villages), 1981 - 2024](assets/pune_transportation_analysis/Pune population (without villages).png){width="900" height="500"}
...
![Figure 4: The number of buses, total and per day, in PMPML’s fleet from 2020 to 2024](assets/pune_transportation_analysis/PMPML fleet.png){width="900" height="500"}
...
|-------|-----------------|
| Pune Station to/from Swargate | 420 |
| Shivajinagar to/from Swargate | 406 |
| Katraj to/from Nigdi | 384 |
| Bhosari to/from Pune station | 302 |
| Manapa to/from Lohegaon | 250 |
| Narhegaon to/from Swargate | 232 |

: Table 2: Total number of buses on 7 major routes in Pune {tbl-colwidths="[65,35]"}
...
![Figure 5: Senapati Bapat Road to SNDT College route](assets/pune_transportation_analysis/SB Road.png){width="450" height="250"}
...
- **Warje – Kharadi**
- **Kothrud – Vishrantwadi** - **Dhayari – Hadapsar**
- **Aundh – Katraj** (which can extend ahead of Aundh towards Kalewadi and Bhosari)

![Figure 6: 4 major corridors that have been identified by PMPML](assets/pune_transportation_analysis/possible routes.png){width="600" height="330"}
...
![Figure 7: Pune’s Vehicle Population, 2000 - 2018](assets/pune_transportation_analysis/Pune's vehicle population.png){width="900" height="500"}
