...
# Price Discrimination Strategies of Air India and Vistara on the Delhi-Mumbai Route
...
**Figure 1: A snapshot of the data used**
*Source: Dataset taken from Kaggle, data was scraped from Ease My Trip*
...
**Figure 2: Average price of an economy class ticket as departure day draws closer**
*Source: Coded in Python by authors*
...
**Figure 3: Average price of a business class ticket as departure day draws closer**
*Source: Coded in Python by authors*
...
**Figure 5: Price for business class depending on flight duration**
*Source: Coded in Python by authors*
...
**Figure 6: Average prices of flight based on the number of stops**
*Source: Coded in Python by authors*
